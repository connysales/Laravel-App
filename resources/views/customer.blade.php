            ...
            <div class="col-md-3 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="mb-0 mt-2 text-danger">0% <span class="text-black ms-1"><small>( 0 day)</small></span></p>
                </div>
              </div>
            </div>
            <div class="col-md-3 grid-margin stretch-card">
            ...
            <div class="col-md-3 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="mb-0 mt-2 text-success">0%<span class="text-black ms-1"><small>( 0 day)</small></span></p>
                </div>
              </div>
            </div>
            <div class="col-md-3 grid-margin stretch-card">
