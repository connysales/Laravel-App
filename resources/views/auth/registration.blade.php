            ...
            <form action="{{ route('register.post') }}" method="POST">
              ...
              <div class="row gy-3 gy-md-4 overflow-hidden">
                <div class="col-12">
                    ...
                    <input type="email" class="form-control" name="name" id="email" placeholder="name" required>
                    @if ($errors->has('name'))
                ...
                <div class="col-12">
                    ...
                    <input type="password" class="form-control" name="confirm_password" id="password" value="" required>
